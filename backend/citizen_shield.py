...
_UI = {
    "en": {
        ...
        "samples": [
            ["💸 UPI 'wrong transfer'", "Sir I accidentally sent ₹5000 to your UPI by mistake. Please accept my collect request and return the money quickly."],
            ["💼 Work-from-home job", "Work from home and earn ₹5000 daily doing simple tasks. Pay a small ₹499 registration fee to get started today."],
            ["🔐 Bank 'security' call", "I am calling from your bank's fraud department. A transaction of ₹49,000 is in progress. Tell me the OTP I just sent to cancel it."],
        ],
        "safe_actions": [
    ...
    "hi": {
        ...
        "samples": [
            ["💸 UPI 'गलत ट्रांसफर'", "सर मैंने गलती से आपके यूपीआई पर ₹5000 भेज दिए हैं। कृपया मेरी कलेक्ट रिक्वेस्ट स्वीकार करके पैसे जल्दी वापस कर दीजिए।"],
            ["💼 घर बैठे नौकरी", "घर बैठे रोज ₹5000 कमाइए, बस आसान टास्क करने हैं। आज ही शुरू करने के लिए ₹499 रजिस्ट्रेशन शुल्क भरें।"],
            ["🔐 बैंक 'सुरक्षा' कॉल", "मैं आपके बैंक के फ्रॉड विभाग से बोल रहा हूँ। ₹49,000 का लेनदेन हो रहा है। इसे रोकने के लिए अभी भेजा गया ओटीपी बताइए।"],
        ],
        "safe_actions": [
    ...
    "ta": {
        ...
        "samples": [
            ["💸 UPI 'தவறான பரிமாற்றம்'", "ஐயா தவறுதலாக உங்கள் UPI க்கு ₹5000 அனுப்பிவிட்டேன். என் கலெக்ட் ரிக்வெஸ்ட்டை ஏற்று பணத்தை விரைவாகத் திருப்பி அனுப்புங்கள்."],
            ["💼 வீட்டிலிருந்து வேலை", "வீட்டிலிருந்தே தினமும் ₹5000 சம்பாதியுங்கள், எளிய பணிகள் மட்டுமே. இன்றே தொடங்க ₹499 பதிவுக் கட்டணம் செலுத்துங்கள்."],
            ["🔐 வங்கி 'பாதுகாப்பு' அழைப்பு", "உங்கள் வங்கியின் மோசடி பிரிவிலிருந்து பேசுகிறேன். ₹49,000 பரிவர்த்தனை நடக்கிறது. அதை நிறுத்த இப்போது அனுப்பிய OTP ஐச் சொல்லுங்கள்."],
        ],
        "safe_actions": [
    ...
    "bn": {
        ...
        "samples": [
            ["💸 UPI 'ভুল ট্রান্সফার'", "স্যার ভুল করে আপনার UPI-তে ₹5000 পাঠিয়ে ফেলেছি। দয়া করে আমার কালেক্ট রিকোয়েস্ট গ্রহণ করে টাকাটা তাড়াতাড়ি ফেরত দিন।"],
            ["💼 বাড়ি থেকে কাজ", "বাড়ি বসে প্রতিদিন ₹5000 আয় করুন, শুধু সহজ কাজ। আজই শুরু করতে ₹499 রেজিস্ট্রেশন ফি দিন।"],
            ["🔐 ব্যাঙ্কের 'নিরাপত্তা' কল", "আমি আপনার ব্যাঙ্কের ফ্রড বিভাগ থেকে বলছি। ₹49,000 টাকার লেনদেন হচ্ছে। সেটি আটকাতে এইমাত্র পাঠানো OTP বলুন।"],
        ],
        "safe_actions": [
