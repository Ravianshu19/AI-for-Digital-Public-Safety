...
SIGNAL_GROUPS: List[Dict] = [
    {
        ...
        "patterns": [
            r"सीबीआई",
            r"सी\.?बी\.?आई",
            r"ईडी अधिकारी|प्रवर्तन निदेशालय",
            r"पुलिस.{0,10}(अधिकारी|इंस्पेक्टर|थाना)",
            r"इंस्पेक्टर|सब.?इंस्पेक्टर",
            r"कस्टम(्स)?|सीमा शुल्क",
            r"आयकर विभाग",
            r"साइबर (सेल|क्राइम|अपराध)",
    ...
    },
    {
        ...
        "weight": 16,
        "patterns": [
            r"पार्सल.{0,15}(ड्रग्स|ड्रग|नशीले|अवैध|पकड़ा|जब्त)",
            r"मनी लॉन्ड्रिंग|मनी लांड्रिंग|धन शोधन",
            r"(एफआईआर|मुकदमा|केस|वारंट).{0,12}(दर्ज|आपके नाम|खिलाफ)",
            r"आधार.{0,12}(दुरुपयोग|इस्तेमाल|उपयोग)",
            r"गैर.?जमानती वारंट",
    ...
    },
    {
        ...
        "weight": 15,
        "patterns": [
            r"किसी को (मत|नहीं) बता(इए|एं|ना)",
            r"गोपनीय (जांच|मामला|मुकदमा)",
            r"(फोन|कॉल) (मत|न) काट(िए|ें|ना)",
            r"(कॉल|लाइन|वीडियो) पर (ही )?रह(िए|ें|ना)",
            r"निगरानी में",
    ...
    },
    {
        ...
        "weight": 22,
        "patterns": [
            r"डिजिटल अरेस्ट|डिजिटल गिरफ्तारी|डिजिटल हिरासत",
            r"वीडियो कॉल पर (रह|बने)",
            r"आप गिरफ्तार ह(ैं|ो)",
            r"आपको गिरफ्तार",
            r"\bdigital arrest\b",
    ...
    },
    {
        ...
        "weight": 20,
        "patterns": [
            r"(पैसा|पैसे|रुपये|राशि|रकम).{0,15}(ट्रांसफर|भेज|जमा|स्थानांतरित)",
            r"आरबीआई.{0,10}(खाता|अकाउंट|सत्यापन)",
            r"(सत्यापन|वेरिफिकेशन).{0,12}(खाता|अकाउंट|के लिए)",
            r"सारा (पैसा|धन|रुपया).{0,10}(भेज|ट्रांसफर|जमा)",
            r"सुरक्षित खाते में",
    ...
    # ---- Broader scam families (beyond digital-arrest) ----------------------
    {
        ...
        "weight": 20,
        "patterns": [
            r"(ओटीपी|ओ\.?टी\.?पी).{0,10}(बता|साझा|भेज|दें|दीजिए|शेयर)",
            r"(पिन|सीवीवी|पासवर्ड).{0,10}(बता|साझा|भेज|दें|शेयर)",
